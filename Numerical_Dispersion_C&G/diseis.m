function diseis (a,scal,x,z,amx)
%% 
% diseis: is a plot seismic data using wiggles but displays the screen as 
% a normal seismic display such as those seen using SeismicUnix. 
%
%  diseis (a,scal,x,z,amx) 
%
%  Input    a       : seismic data
...
%'LineWidth',linewidth, ...
% 'Xdata', x(i)+[0 0], 'Ydata',[z0 z1]*dz);	% remove zero line
